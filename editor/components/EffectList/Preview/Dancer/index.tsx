...
import { setCurrentPosByName, toggleSelectedDancer } from "core/actions";
 ...
 */
class Dancer {
    constructor(id: number, name: string | number, app: object, loadTexture: object, mainContainer: object) {
        this.app = app;
        ...
        Object.entries(BLPARTS).forEach(([blpart, settings]) => {
            this.parts[blpart] = new BlackPart(this, blpart, settings, loadTexture["BLPARTS"][blpart]);
        });
        // ELPart
        Object.entries(ELPARTS).forEach(([elpart, settings]) => {
            this.parts[elpart] = new ELPart(this, elpart, settings, loadTexture["ELPARTS"][elpart]);
        });
        // LEDPART
        Object.entries(LEDPARTS).forEach(([ledpart, settings]) => {
            this.parts[ledpart] = new LEDPart(this, ledpart, settings, loadTexture["LEDPARTS"][ledpart]);
        });
