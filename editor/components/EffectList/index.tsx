...
import { selectGlobal, setEffectRecordMap, setEffectStatusMap } from "slices/globalSlice";
...
export default function EffectList() {
    ...
    const handleDeleteEffect = () => {
        // todo: global slice deleteEffect
        setDeleteOpened(false);
    };
    ...
    return (
        <div>
                    ...
                    <>
                        <React.Fragment key={key}>
                            <ListItem
                                secondaryAction={
                                    mode === "APPLY" ? (
                                        <IconButton edge="end" aria-label="apply" onClick={() => handleOpenApply(key)}>
            ...
            <Dialog open={applyOpened}>
                ...
                <DialogContent>
                    <DialogContentText>
                        Are you sure to apply effect "{effectSelected}" to current record? This will insert{" "}
                        {effectRecordMap[effectSelected] ? effectRecordMap[effectSelected].length : 0} frame(s) to
                        current time spot.
                    </DialogContentText>
                </DialogContent>
                <DialogActions>
