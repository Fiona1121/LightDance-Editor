...
export default function ModeSelector({ handleSave, handleDelete }) {
    ...
    return (
        <div>
            ...
            <Button variant="outlined" size="small" color="primary" disabled={mode === IDLE} onClick={handleSave}>
                SAVE
            </Button>
            <Button size="small" variant="outlined" color="secondary" onClick={handleDelete} disabled={mode !== IDLE}>
                DEL
            </Button>
            <Button size="small" variant="outlined" color="primary" onClick={handleSaveToLocal} disabled={false}>
                SAVE_LOCAL
            </Button>
        </div>
    );
