import { SUB_POS_RECORD, SUB_POS_MAP, SUB_CONTROL_RECORD, SUB_CONTROL_MAP, SUB_EFFECT_LIST } from "../graphql";
                    ...
                    client.cache.modify({
                        ...
                        fields: {
                            positionFrameIDs(positionFrameIDs: Array<string>) {
                                if (data.data.positionRecordSubscription.mutation === "CREATED") {
                                    return [
                                        ...positionFrameIDs.slice(0, data.data.positionRecordSubscription.index),
                                        data.data.positionRecordSubscription.frameID,
                                        ...positionFrameIDs.slice(data.data.positionRecordSubscription.index),
                                    ];
                                } else if (data.data.positionRecordSubscription.mutation === "DELETED") {
                                    return positionFrameIDs.filter((e: string) => {
                                        return e !== data.data.positionRecordSubscription.frameID;
                                    });
                                } else if (data.data.positionRecordSubscription.mutation === "MIXED") {
                                    return [
                                        ...positionFrameIDs.slice(0, data.data.positionRecordSubscription.index),
                                        ...data.data.positionRecordSubscription.addID,
                                        ...positionFrameIDs.slice(data.data.positionRecordSubscription.index),
                                    ].filter((e: string) => !data.data.positionRecordSubscription.deleteID.includes(e));
                                }
                            },
                        },
                    });
            ...
            next(data) {
                if (userID !== data.data.positionMapSubscription.editBy) {
                    client.cache.modify({
                        ...
                        fields: {
                            PosMap(posMap) {
                                if (data.data.positionMapSubscription.mutation === ("CREATED" || "UPDATED")) {
                                    return {
                                        ...posMap,
                                        frames: {
                                            ...posMap.frames,
                                ...
                                } else if (data.data.positionMapSubscription.mutation === "DELETED") {
                                    return {
                                        ...posMap,
                                        frames: lodash.omit(posMap.frames, data.data.positionMapSubscription.frameID),
                                    };
                                }
                            },
                        },
                    ...
                    client.cache.modify({
                        ...
                        fields: {
                            controlFrameIDs(controlFrameIDs: Array<string>) {
                                if (data.data.controlRecordSubscription.mutation === "CREATED") {
                                    return [
                                        ...controlFrameIDs.slice(0, data.data.controlRecordSubscription.index),
                                        data.data.controlRecordSubscription.frameID,
                                        ...controlFrameIDs.slice(data.data.controlRecordSubscription.index),
                                    ];
                                } else if (data.data.controlRecordSubscription.mutation === "DELETED") {
                                    return controlFrameIDs.filter((e: string) => {
                                        return e !== data.data.controlRecordSubscription.frameID;
                                    });
                                } else if (data.data.controlRecordSubscription.mutation === "MIXED") {
                                    return [
                                        ...controlFrameIDs.slice(0, data.data.controlRecordSubscription.index),
                                        ...data.data.controlRecordSubscription.addID,
                                        ...controlFrameIDs.slice(data.data.controlRecordSubscription.index),
                                    ].filter((e: string) => !data.data.controlRecordSubscription.deleteID.includes(e));
                                }
                            },
                        },
                    });
                    ...
                    client.cache.modify({
                        ...
                        fields: {
                            ControlMap(controlMap) {
                                if (data.data.controlMapSubscription.mutation === ("CREATED" || "UPDATED")) {
                                    return {
                                        ...controlMap,
                                        frames: {
                                            ...controlMap.frames,
                                ...
                                } else if (data.data.controlMapSubscription.mutation === "DELETED") {
                                    return {
                                        ...controlMap,
                                        frames: lodash.omit(
                                            controlMap.frames,
...
const subEffectList = (client, userID) => {
    client
        .subscribe({
        ...
        .subscribe({
            next(data) {
                if (userID !== data.data.effectListSubscription.editby) {
                    client.cache.modify({
                        id: "ROOT_QUERY",
                        fields: {
