...
export const controlAgent = {
    ...
    addFrame: async (
        frame: DancerCoordinates | ControlMapStatus | EffectStatusMapElementType,
        currentTime: number,
        frameIndex: number,
        fade?: boolean
    ) => {
                            ...
                            ControlMap(controlMap) {
                                return {
                                    ...
                                    frames: {
                                        ...controlMap.frames,
                                        [Object.keys(editControlMap.frame)[0]]: {
                                            ...editControlMap.frame[Object.keys(editControlMap.frame)[0]],
                                        },
                                    },
                                };
                            },
            ...
            await client.mutate({
                ...
                update: (cache, { data: { deleteControlFrame } }) => {
                    cache.modify({
                        ...
                        fields: {
                            controlFrameIDs(controlFrameIDs) {
                                return controlFrameIDs.filter((e: String) => e !== deleteControlFrame.id);
                            },
                            ControlMap(controlMap) {
                                return {
                                    ...controlMap,
            ...
            await client.mutate({
                ...
                update: (cache, { data: { deletePositionFrame } }) => {
                    cache.modify({
                        ...
                        fields: {
                            positionFrameIDs(positionFrameIDs) {
                                return positionFrameIDs.filter((e: String) => e !== deletePositionFrame.id);
                            },
                            PosMap(posMap) {
                                return {
                                    ...posMap,
...
export const uploadeExportDataApi = async (uploadFile) => {
    ...
    if (response.request.statusText === "OK") alert("Upload Success.Please refresh.");
