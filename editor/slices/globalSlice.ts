...
import { GlobalState, EffectRecordMapType, EffectStatusMapType, EffectRecordType } from "../types/globalSlice";
...
export const globalSlice = createSlice({
    ...
    reducers: {
        ...
        addEffect: (
            ...
            state.effectRecordMap[effectName] = state.controlRecord.slice(startIndex, endIndex);
